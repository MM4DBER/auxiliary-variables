...
1. [Introduction to Latent Class Analysis (LCA) with MplusAutomation](https://youtu.be/fPpcScLZFRI?si=S_LgBjBDCbXSuJP9)

2. [3-Step ML Auxiliary Variable Integration Using MplusAutomation](https://youtu.be/MZSFKmTLZRI?si=IWWBCOTBOg8NZx3c)
...
### Present variables table syntax: Take a look at the indicators that compose the LCA ###
...
include_graphics("figures/c3_lca_plot.png")
```
